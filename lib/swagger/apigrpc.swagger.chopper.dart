...
class _$Apigrpc extends Apigrpc {
  ...
  Future<Response<ApiSession>> nakamaAuthenticateSteam(
      {ApiAccountSteam body, bool create, String username}) {
  ...
  @override
  Future<Response<dynamic>> nakamaLinkSteam({ApiAccountSteam body}) {
  ...
  @override
  Future<Response<dynamic>> nakamaAddGroupUsers({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaBanGroupUsers({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaDemoteGroupUsers({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaJoinGroup({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaKickGroupUsers({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaLeaveGroup({String groupId}) {
  ...
  @override
  Future<Response<dynamic>> nakamaPromoteGroupUsers({String groupId}) {
  ...
  Future<Response<ApiLeaderboardRecordList>>
      nakamaListLeaderboardRecordsAroundOwner(
          {String leaderboardId, String ownerId, int limit, String expiry}) {
  ...
  @override
  Future<Response<dynamic>> nakamaJoinTournament({String tournamentId}) {
