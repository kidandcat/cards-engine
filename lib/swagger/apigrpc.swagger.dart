...
extension $WriteLeaderboardRecordRequestLeaderboardRecordWriteExtension
  ...
  WriteLeaderboardRecordRequestLeaderboardRecordWrite copyWith(
      {String score, String subscore, String metadata}) {
...
class ApiAccount {
  ...
  @JsonKey(name: 'email')
  final String email;
  @JsonKey(name: 'devices', defaultValue: <ApiAccountDevice>[])
...
class ApiChannelMessageList {
  ...
  @JsonKey(name: 'messages', defaultValue: <ApiChannelMessage>[])
...
class ApiDeleteStorageObjectsRequest {
  ...
  @JsonKey(name: 'objectIds', defaultValue: <ApiDeleteStorageObjectId>[])
...
extension $ApiEventExtension on ApiEvent {
  ApiEvent copyWith(
      {String name, Object properties, DateTime timestamp, bool $external}) {
    return ApiEvent(
        name: name ?? this.name,
...
class ApiFriendList {
  ...
  @JsonKey(name: 'friends', defaultValue: <ApiFriend>[])
...
class ApiGroupList {
  ...
  @JsonKey(name: 'groups', defaultValue: <ApiGroup>[])
...
class ApiGroupUserList {
  ...
  @JsonKey(name: 'groupUsers', defaultValue: <GroupUserListGroupUser>[])
...
class ApiMatchList {
  ...
  @JsonKey(name: 'matches', defaultValue: <ApiMatch>[])
...
class ApiNotificationList {
  ...
  @JsonKey(name: 'notifications', defaultValue: <ApiNotification>[])
...
class ApiReadStorageObjectsRequest {
  ...
  @JsonKey(name: 'objectIds', defaultValue: <ApiReadStorageObjectId>[])
...
class ApiStorageObjectAcks {
  ...
  @JsonKey(name: 'acks', defaultValue: <ApiStorageObjectAck>[])
...
class ApiStorageObjectList {
  ...
  @JsonKey(name: 'objects', defaultValue: <ApiStorageObject>[])
...
class ApiTournamentList {
  ...
  @JsonKey(name: 'tournaments', defaultValue: <ApiTournament>[])
...
extension $ApiTournamentListExtension on ApiTournamentList {
  ApiTournamentList copyWith({List<ApiTournament> tournaments, String cursor}) {
...
class ApiUserGroupList {
  ...
  @JsonKey(name: 'userGroups', defaultValue: <UserGroupListUserGroup>[])
...
class ApiUsers {
  ...
  @JsonKey(name: 'users', defaultValue: <ApiUser>[])
...
class ApiWriteStorageObjectsRequest {
  ...
  @JsonKey(name: 'objects', defaultValue: <ApiWriteStorageObject>[])
